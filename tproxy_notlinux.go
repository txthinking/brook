...
// NewTproxy.
func NewTproxy(addr, server, password string, enableIPv6 bool, cidr4url, cidr6url string, tcpTimeout, udpTimeout int, address string, insecure bool) (*Tproxy, error) {
